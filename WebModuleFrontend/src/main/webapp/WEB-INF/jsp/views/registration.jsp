...
<head>
    ...
    <title>Registration | Aplikácia dotazníkov</title>
...
<div class="container">
    ...
    <form:form name="f" action="${pageContext.request.contextPath}/registration" method="post" modelAttribute="uzivatel" cssClass="form-signin">
